...
echo "    try:" >> $TARGETFILE
echo "        connect('TEST','{JZRUcv62QnG7oxKGrzD3}','t3://$host_ip_local:$admin_server_port')" >> $TARGETFILE
...
echo "wlDeploy('TEST','JZRUcv62QnG7oxKGrzD3','t3://$host_ip_local:$admin_server_port','wls-exporter','G:/wls-exporter/wls-exporter.war')" >> $TARGETFILE
